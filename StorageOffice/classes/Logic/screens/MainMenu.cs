...
/// This class provides an interactive console-based workflow for navigating through
/// the main options of the application.
/// </summary>
/// <remarks>
/// The menu allows navigation through a list of options and invokes the appropriate
...
/// </param>
/// <param name="select">
/// A <see cref="Select"/> instance containing the list of options available in the menu.
/// </param>
/// <param name="onExit">
...
public class MainMenu
{
    ...
    /// <summary>
    /// Executes the main workflow for the main menu.
    ...
    /// <summary>
    /// Displays the user interface for the main menu.
    /// Shows the list of available options and provides navigation instructions for the user.
    /// </summary>
    /// <remarks>
